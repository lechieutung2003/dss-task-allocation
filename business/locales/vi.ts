const vi = {
  ...
  create_order_bank_transfer: 'Chuyển khoản ngân hàng',
  create_order_bank_description: 'Thanh toán qua chuyển khoản ngân hàng với mã QR',
  ...
  payment_redirecting: 'Đang chuyển đến trang thanh toán...',
  ...
  payment_error_title: 'Không thể tải thông tin thanh toán',
  payment_no_info_error: 'Không tìm thấy thông tin thanh toán cho đơn hàng này',
  payment_load_error: 'Không thể tải thông tin đơn hàng',
  payment_title: 'Thanh toán đơn hàng',
  payment_subtitle: 'Vui lòng hoàn tất thanh toán để xác nhận đơn hàng',
  payment_order_summary: 'Thông tin đơn hàng',
  payment_service: 'Dịch vụ:',
  payment_area: 'Diện tích:',
  payment_start_time: 'Thời gian bắt đầu:',
  payment_total_amount: 'Tổng thanh toán:',
  payment_bank_transfer_title: 'Thông tin chuyển khoản',
  payment_qr_instruction: 'Quét mã QR để chuyển khoản',
  payment_qr_loading: 'Đang tạo mã QR...',
  payment_qr_error: 'Không thể tạo mã QR',
  payment_bank_info: 'Thông tin tài khoản',
  payment_bank_name: 'Ngân hàng:',
  payment_account_number: 'Số tài khoản:',
  payment_account_name: 'Tên tài khoản:',
  payment_amount: 'Số tiền:',
  payment_transfer_content: 'Nội dung chuyển khoản:',
  payment_important_notice: 'Lưu ý quan trọng',
  payment_notice_1: 'Vui lòng chuyển khoản ĐÚNG số tiền và nội dung để đơn hàng được xác nhận tự động',
  payment_notice_2: 'Không thêm bất kỳ ký tự nào vào nội dung chuyển khoản',
  payment_notice_3: 'Thời gian xử lý: 1-5 phút sau khi chuyển khoản thành công',
  payment_checking_status: 'Đang kiểm tra thanh toán...',
  payment_pending: 'Chưa thanh toán',
  payment_confirmed: 'Đã thanh toán thành công',
  payment_checking: 'Đang kiểm tra...',
  payment_confirmed_button: 'Đã xác nhận',
  payment_check_button: 'Kiểm tra thanh toán',
  payment_view_invoice: 'Xem hóa đơn',
  payment_back_orders: 'Quay lại danh sách đơn hàng',
  payment_cash_title: 'Thanh toán tiền mặt',
  payment_cash_description: 'Bạn sẽ thanh toán bằng tiền mặt khi nhân viên hoàn thành dịch vụ. Vui lòng chuẩn bị số tiền chính xác.',
  payment_success: 'Thanh toán thành công! Đơn hàng đã được xác nhận.',
  payment_still_pending: 'Chưa nhận được thanh toán. Vui lòng kiểm tra lại.',
  payment_check_error: 'Không thể kiểm tra trạng thái thanh toán',
  payment_no_order_code: 'Không tìm thấy mã đơn hàng',
  payment_bank_transfer: 'Chuyển khoản ngân hàng',
  payment_confirm_transferred: 'Tôi đã chuyển khoản',
  payment_cancel: 'Hủy',
