const en = {
  ...
  // Payment Page
  payment_loading: 'Loading payment info...',
  payment_error_title: 'Unable to load payment info',
  payment_no_info_error: 'No payment info found for this order',
  payment_load_error: 'Unable to load order info',
  payment_title: 'Pay for order',
  payment_subtitle: 'Please complete payment to confirm order',
  payment_order_summary: 'Order info',
  payment_service: 'Service:',
  payment_area: 'Area:',
  payment_start_time: 'Start time:',
  payment_total_amount: 'Total payment:',
  payment_bank_transfer_title: 'Transfer info',
  payment_qr_instruction: 'Scan QR code to transfer',
  payment_qr_loading: 'Generating QR code...',
  payment_qr_error: 'Unable to generate QR code',
  payment_bank_info: 'Account information',
  payment_bank_name: 'Bank:',
  payment_account_number: 'Account number:',
  payment_account_name: 'Account name:',
  payment_amount: 'Amount:',
  payment_transfer_content: 'Transfer content:',
  payment_important_notice: 'Important note',
  payment_notice_1: 'Please transfer the CORRECT amount and content for the order to be automatically confirmed',
  payment_notice_2: 'Do not add any characters to the transfer content',
  payment_notice_3: 'Processing time: 1-5 minutes after successful transfer',
  payment_checking_status: 'Checking payment...',
  payment_pending: 'Not paid yet',
  payment_confirmed: 'Payment successful',
  payment_checking: 'In progress check...',
  payment_confirmed_button: 'Confirmed',
  payment_check_button: 'Check payment',
  payment_view_invoice: 'View invoice',
  payment_back_orders: 'Return to order list',
  payment_cash_title: 'Pay in cash',
  payment_cash_description: 'You will pay in cash when the staff completes the service. Please prepare the exact amount.',
  payment_success: 'Payment successful! Order has been confirmed.',
  payment_still_pending: 'Payment not yet received. Please check again.',
  payment_check_error: 'Unable to check payment status',
  payment_no_order_code: 'Order code not found',
  payment_bank_transfer: 'Bank transfer',
  payment_confirm_transferred: 'I have transferred',
